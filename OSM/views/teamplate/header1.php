                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <!-- Search Form -->
						<div class="search-top">
							...
							<!-- Search Form -->
							<div class="search-top" >
								<form class="search-form" method="get" action="tim-kiem.php" style ="outline: none;">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="all-category">
                            <h3 class="cat-heading"> <button id="toggle-icon" class="custom-icon"><i class="fa fa-bars" aria-hidden="true"></i></button>Danh Mục</h3>
                            <ul id="main-menu" class="main-category">
                                <?php foreach($data as $value): ?>
                                <li>
                                    <a href="san-pham.php?action=category&id=<?php echo $value['id'] ?>" <?php 
                                    ...
                                    <ul class="sub-category">
                                        ...
                                        <li><a
                                                href="san-pham.php?action=sub_cate&id=<?php echo $sub['id'] ?>"><?php echo $sub['name'] ?></a>
                                        </li>
                                        <?php endforeach; ?>
                                    </ul>
                                    <?php endif ?>
...
<script>
    ...
    let btnIcon = document.getElementById('toggle-icon');
    btnIcon.addEventListener('click', function(e) {
        menu.classList.toggle("main-category-click");
    });
</script>